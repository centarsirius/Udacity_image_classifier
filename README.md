# Udacity_image_classifier. Image classification (102 flower categories) using Pytorch models.

In this project, code is developed for an image classifier built with PyTorch, then converted into a command line applications: train.py, predict.py.
